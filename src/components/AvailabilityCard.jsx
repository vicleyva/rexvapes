...
export default function AvailabilityCard({ flavor }) {
  ...
  return (
    <div className={`rounded-xl border-2 p-3 transition-all h-full flex flex-col ${
      isAvailable
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0">
          <h3 className={`font-semibold truncate text-sm ${isAvailable ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400'}`}>
            {flavor.name}
          </h3>
          {flavor.name_es && (
      ...
      <div className={`mt-auto pt-2 text-center text-xs font-medium ${
